            ...
            <div class="flex items-center px-3 py-4 bg-white rounded-md shadow-sm">
              ...
              <div class="mx-5 w-full">
                <div class="flex justify-between my-auto">
                  ...
                  <RouterLink :to="{ name: 'pending' }" class="flex border p-1 px-3 rounded-2xl border-amber-400">
              ...
              <table class="min-w-full">
                ...
                <tbody class="bg-white">
                  <tr v-for="(m, index) in store.topMovements" :key="index">
                    ...
                    <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap">
                      <div class="inline-flex text-xs font-semibold leading-5 ">{{ m.movementType?.name }}</div>
        ...
        <div class="flex flex-col w-full lg:w-1/4">
          ...
          <div class="my-1 pr-1 overflow-auto lg:scroll-pr-2 min-w-full">
            <div class="align-middle ">
              <ExpectedPaymentItem v-for="payment in store.summaryByPaymentMethods" :key="payment.cardName"
                :payment="payment" />
            </div>
          </div>
        </div>
